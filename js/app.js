...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <h4 class="title hover-underline-animation ">${product.title}</h4>
      <p>Category: ${product.category}</p>
      <h3 class="price  hover-underline-animation">Price: $ ${product.price}</h3>
      <span class="rating">Rating: ${product.rating.rate}</span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star-half-alt"></i></span>
      <span class="star-rating"><i class="far fa-star"></i></span>
